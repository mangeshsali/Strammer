...
export const SEARCH_API =
  "https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=2&key=" +
  API_KEY;
...
export const RECOMMAND_API =
  "https://youtube.googleapis.com/youtube/v3/videos?part=snippet&part=statistics&part=contentDetails&chart=mostPopular&maxResults=5&regionCode=IN&key=" +
  API_KEY +
  "&videoCategoryId=";
